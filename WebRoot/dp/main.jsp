  	     ...
  	     <div class="content">
  	     	...
  	     	<div class="blog-list">
  	     		...
  	     		<!-- 一条博客 -->
	  	     		<div class="blog-item">
	  	     				<dl>
	  	     					<dt><a href="#">文件上传利器SWFUpload入门简易教程</a></dt>
	  	     					<dd>
	  	     						<p>凡做过网站开发的都应该知道表单file的确鸡肋。Ajax解决了不刷新页面提交表单，但是却没有解决文件上传不刷新页面，当然也有其它技术让不刷新页面而提交文件，该技术主要是利用隐藏的iFrame，较Ajax要麻烦许多，而且其提交方式依然在底层是使用的表单file，这里我们不详谈。而且如果是提交较小的文件，我们能接受，如果提交的文件较大，我们便要忍受很长的等待时间，而浏览器却没有任何提示，我们也没有</p>
	  	     					</dd>
